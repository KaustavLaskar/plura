...
type Props = {
    apiEndpoint : 'agencyLogo' | 'avatar' | 'subaccount'
...
const FileUpload = ({apiEndpoint, onChange, value}: Props) => {
    ...
    if(value){
        return <div className="flex flex-col justify-center items-center">{type !== 'pdf' ? (
            <div className="relative w-40 h-40">
                <Image src = {value} alt = "upload-image" className="object-container" fill></Image>
            </div>
        ) : (
